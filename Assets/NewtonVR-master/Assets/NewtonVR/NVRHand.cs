    ...
    public class NVRHand : MonoBehaviour
    {
        ...
        private IEnumerator DoInitialize()
        {
            ...
            else if (RenderModelInitialized == false)
            {
                ...
                Vector3 handscale = new Vector3(1.0f, 1.0f, 1.0f);
                Vector3 HandPos = new Vector3(0.38f,-1.25f,-0.41f);
                Quaternion HandRotation = Quaternion.Euler(new Vector3(336.5f, 267.8101f, 59.01006f)); //new Quaternion(-30f,85f, 70f,1f);
                CustomModelObject.transform.parent = this.transform;
                CustomModelObject.transform.localScale = handscale;
                CustomModelObject.transform.localPosition = HandPos;
